...
//			CoerceTypes(ref m, ref n);
		...
		public static object AddIfPossible2(object m, object n)
		{
			...
			// todo: czy to siê op³aca? mo¿e dla pewnych typów lepiej z haszmapy braæ operatory? bêdzie wolniej. ale bez przesady
	...
	// todo: jak wykryæ SZYBKO, ¿e dany typ jest konwertowalny do Decimala? -----------------------------------------------------
