...
namespace SpringCollections
{
	...
	/// <see cref="SpringCollections.ISet"/> abstraction. The order of
	/// elements in a set is dependant on (a)the data-structure implementation, and 
	/// (b)the implementation of the various
	/// <see cref="SpringCollections.ISet"/> methods, and thus is not
	/// guaranteed.
	/// </p>
	/// <p>
	/// <see cref="SpringCollections.ISet"/> overrides the
	...
	public interface ISet : ICollection, ICloneable
	{
		...
		/// <see cref="SpringCollections.ISet"/> containing the elements from
		/// the operation.
		/// </p>
		/// </remarks>
		/// <param name="setOne">A set of elements.</param>
