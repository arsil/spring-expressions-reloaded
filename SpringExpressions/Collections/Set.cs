...
namespace SpringCollections
{
	/// <summary>
	/// A collection that contains no duplicate elements.
	/// </summary>
	/// <seealso cref="SpringCollections.ISet"/>
    [Serializable]
    public abstract class Set : ISet
	{
		...
		/// <returns>
		/// A new <see cref="SpringCollections.ISet"/> containing the union of
		/// this <see cref="SpringCollections.ISet"/> with the specified
		/// collection. Neither of the input objects is modified by the union.
		/// </returns>
		/// <see cref="SpringCollections.ISet.Union(ISet)"/>
		...
		/// </returns>
		/// <see cref="SpringCollections.ISet.Intersect(ISet)"/>
		...
		/// </returns>
		/// <seealso cref="SpringCollections.ISet.Minus(ISet)"/>
		...
		/// </returns>
		/// <seealso cref="SpringCollections.ISet.ExclusiveOr(ISet)"/>
		...
		/// <summary>
		/// Returns a clone of the <see cref="SpringCollections.ISet"/>
		/// instance.
		/// </summary>
		/// <remarks>
		/// <p>
		/// This will work for derived <see cref="SpringCollections.ISet"/>
		...
		/// <summary>
		/// Copies the elements in the <see cref="SpringCollections.ISet"/> to
		/// an array.
		/// </summary>
		/// <remarks>
		/// <p>
		/// The type of array needs to be compatible with the objects in the
		/// <see cref="SpringCollections.ISet"/>, obviously.
		/// </p>
		/// </remarks>
		/// <param name="array">
		...
		/// <see cref="SpringCollections.ISet"/> is synchronized across
		/// threads.
		/// </summary>
		/// <remarks>
		/// <p>
		...
		/// <see cref="SpringCollections.ISet"/>.
		/// </summary>
		/// <returns>
		/// An <see cref="System.Collections.IEnumerator"/> over the elements
		/// in the <see cref="SpringCollections.ISet"/>.
		/// </returns>
		public abstract IEnumerator GetEnumerator();

		/// <summary>
		/// This method will test the <see cref="SpringCollections.ISet"/>
		/// against another <see cref="SpringCollections.ISet"/> for
		/// "equality".
		/// </summary>
		/// <remarks>
		/// <p>
		...
		/// <see cref="SpringCollections.ISet"/> instances, use
		/// <c>Equals()</c>. If you wish to check to see if two references are
		/// actually the same object, use "==" and "!=".  
		/// </p>
		/// </remarks>
		/// <param name="obj">
		/// A <see cref="SpringCollections.ISet"/> object to compare to.
		/// </param>
		/// <returns>
