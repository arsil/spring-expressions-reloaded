...
{
    /// <summary>
    /// <see cref="SpringCollections.DictionarySet"/> is an
    /// <see langword="abstract"/> class that supports the creation of new
    /// <see cref="SpringCollections.ISet"/> types where the underlying data
    ...
    /// <see cref="SpringCollections.ISet"/> using it.
    /// </p>
    /// <p>
    ...
    /// the <see cref="SpringCollections.DictionarySet"/> class is mutable.
    /// Therefore, it is not safe to use as a key value in a dictionary.
    /// </p>
    /// <p>
    /// To make a <see cref="SpringCollections.ISet"/> typed based on your
    /// own <see cref="System.Collections.IDictionary"/>, simply derive a new
    /// class with a constructor that takes no parameters. Some
    /// <see cref="SpringCollections.ISet"/> implmentations cannot be defined
    ...
    /// <see cref="SpringCollections.ISet"/> as an argument.
    /// </p>
    /// </remarks>
    ...
    public abstract class DictionarySet : Set
    {
        ...
        /// <see cref="SpringCollections.ISet"/>s.
        /// </remarks>
        ...
        /// threads.
        /// </summary>
        /// <seealso cref="SpringCollections.Set.IsSynchronized"/>
        ...
        /// it thread-safe.
        /// </value>
        /// <seealso cref="SpringCollections.Set.SyncRoot"/>
