	...
	public void mTYPE(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
	...
	public void mSAFE_DOT(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = SAFE_DOT;
	...
	public void mSAFE_LBRACKET(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		int _ttype; IToken _token=null; int _begin=text.Length;
		_ttype = SAFE_LBRACKET;
			...
			if ( synPredMatched215 )
			{
				{ // ( ... )+
					...
					for (;;)
					{
						...
						{
							if (_cnt217 >= 1) { goto _loop217_breakloop; } else { throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());; }
						}
...
_loop256_breakloop:				;
			...
			{ // ( ... )+
				...
				for (;;)
				{
					...
					{
						if (_cnt258 >= 1) { goto _loop258_breakloop; } else { throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());; }
					}
