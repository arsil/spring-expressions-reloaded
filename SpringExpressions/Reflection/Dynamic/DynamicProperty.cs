...
namespace SpringReflection.Dynamic
{
    ...
    public class SafeProperty : IDynamicProperty
    {
        ...
        private static readonly object[] DummyParams = new object[0];
        ...
        {
            return getter(target, DummyParams);
        }
        ...
        {
            setter(target, value, DummyParams);
        }
    ...
    class DynamicProperty : BaseDynamicMember
    {
        /// <summary>
