...
namespace SpringExpressions
{
    ...
    public class ConstructorNodeTests
    {
        ...
        public void CanCreatePublicInstance()
        {
            ...
            // (IExpression)ctorNode still COMPILES - BaseNode is not sealed - but throws
            // InvalidCastException now that nodes no longer implement IExpression. Expression.Wrap is the
            // replacement.
